...
def get_city():
    ...
    '''
    city = input('\nHello! We will see analysis of some US bikeshare data!\n'
                 'Which data would you like to see: for Chicago, New York, or Washington?\n').title()
    if city == 'Chicago' or city == 'C':
        ...
        print("\nPlease try again. Please choose one of the indicated cities.")
        return get_city()
...
def get_time_period():
    ...
    if time_period == 'month' or time_period == 'm':
        ...
        print("\nPlease try again. Please choose one of the indicated answers.")
...
def get_month():
    ...
    if month == 'January':
        ...
        print("\nPlease try again. Please choose one of the indicated months.")
        return get_month()
...
def get_day():
    ...
    if day_of_week == 'Monday':
        ...
        print("\nPlease try again. Please choose one of the indicated days.")
        return get_day()
...
def statistics():
    ...
    def restart_question():
        ...
        Returns:
        '''
        restart = input('\nWould you like to restart? Type \'yes\' or \'no\'. (no - end of the program.)\n')
